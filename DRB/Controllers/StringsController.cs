        ...
        public ActionResult Index(SettingsTb data)
        {
            try
            {
                using (var db = new drbContext())
                {
                    ...
                    obj.SystemProfitPercentagePerOrder = data.SystemProfitPercentagePerOrder;
                    obj.SystemProfitFromOrderCancel = data.SystemProfitFromOrderCancel;

                    obj.DriverPointsPerEachOrder= data.DriverPointsPerEachOrder;
                    
                    obj.MarchantDefaultShippingPrice = data.MarchantDefaultShippingPrice;
