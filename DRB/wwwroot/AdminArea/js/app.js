...
(function () {
    ...
    function saveTheme(uri) {
        $.ajax({
            url: '/Admin/SaveSiteTheme?s=' + uri,
            async: true,
...
(function () {
    ...
    function initSweetAlert() {
        ...
        $('.player-need-charge').on('click', function (e) {
            e.preventDefault();
            if (lang == "en")
                swal("Can't challenge here", "You have not enough money in your balance. You need to charge your balance.");
            else
                swal("لا يمكنك التحدي هنا", "لا يوجد لديك رصيد كافي. ينبغي شحن رصيدك أولاً");
        });
